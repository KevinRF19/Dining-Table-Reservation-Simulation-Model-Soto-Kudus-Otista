#Hari 4 (Kamis, 22 Juni 2023)
print("Model Solver Reservasi Meja Makan Soto Kudus Otista", end= "\n\n")
print("Kamis, 22 Juni 2023. Pukul 11.00 - 13.30", end= "\n\n")
print("Tamu ke-1, pukul 10.55 - 11.10", end= "\n\n") #tamu 1
c = 2
e = 4
f = 2
s = 0
...
print("Kamis, 22 Juni 2023")
print("Tamu ke-2, pukul 10.59 - 11.24", end= "\n\n") #tamu 2
s = 0
...
print("Kamis, 22 Juni 2023")
print("Tamu ke-3, pukul 11.05 - 11.26", end= "\n\n") #tamu 3
s = 0
...
print(f"Jumlah solusi yang ditemukan: {s}")
print("Nomor meja yang tersisa: 2,3,5,6,7,8", end= "\n\n\n")
...
print(f"Jumlah solusi yang ditemukan: {s}")
print("Nomor meja yang tersisa: 2,3,5,6,7", end= "\n\n\n")
...
print("Kamis, 22 Juni 2023")
print("Tamu ke-13, pukul 12.13 - 12.45", end= "\n\n") #tamu 13
#meja 5
s = 0
...
print("Kamis, 22 Juni 2023")
print("Tamu ke-14, pukul 12.38 - 12.53", end= "\n\n") #tamu 14
s = 0
...
print("Kamis, 22 Juni 2023")
print("Tamu ke-15, pukul 13.12 - 13.34", end= "\n\n") #tamu 15
s = 0
